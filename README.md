...
This is the [Heroku buildpack](https://devcenter.heroku.com/articles/buildpacks) for [ASP.NET Core](https://docs.microsoft.com/en-us/aspnet/core/) and [.NET Core](https://docs.microsoft.com/en-us/dotnet/core/).
